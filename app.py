...
if os.path.exists(disease_model_path):
    ...
    print(f"Error: Model file '{disease_model_path}' not found.")
...
# Loading crop recommendation model
crop_recommendation_model_path = os.path.join(script_dir, 'models', 'RandomForest.pkl')
if os.path.exists(crop_recommendation_model_path):
    crop_recommendation_model = pickle.load(open(crop_recommendation_model_path, 'rb'))
else:
    print(f"Error: Model file '{crop_recommendation_model_path}' not found.")
...
def fert_recommend():
    ...
    # Define the path to the fertilizer CSV file
    fertilizer_csv_path = os.path.join(script_dir, 'Data', 'fertilizer.csv')
    ...
    if os.path.exists(fertilizer_csv_path):
        ...
        return "Error: Fertilizer CSV file not found."
